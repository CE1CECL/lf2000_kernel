...
static int wifi_probe(struct platform_device *pdev)
{
	...
	wifi_irqres = platform_get_resource_byname(pdev, IORESOURCE_IRQ, "bcm4319_wlan_irq");
...
/* by default FW roaming is enabled for all */
uint dhd_roam = 0;
...
dhd_bus_start(dhd_pub_t *dhdp)
{
	...
	// davidychang
	printf("dhd_bus_start: dhd_bus_init fail\n");
	...
	// davidychang
	printf("dhd_bus_start: Exit ret=0\n");
...
dhd_net_attach(dhd_pub_t *dhdp, int ifidx)
{
	...
	// davidychang
	printf("dhd_net_attach: calling register_netdev ...\n");
...
dhd_module_init(void)
{
	...
	// davidychang
	printf("dhd_module_init: wifi_add_dev ..\n");
...
#endif /* #if  defined(CONFIG_WIFI_CONTROL_FUNC) */
	...
	// davidychang
	printf("dhd_module_init: dhd_bus_register ..\n");
...
// davidychang
	...
	// davidychang
	printf("dhd_module_init: Exit=%d\n",error);
	return error;

faild:
	// davidychang
	printf("dhd_module_init: Exit EINVAL\n");
