...
static void init_valencia(void)
{
	...
	/* GPIO Port C */
	gpio_map[DPAD_UP]		= LF2000_GPIO_PORT_C | 0;
	...
	gpio_map[DPAD_LEFT]		= LF2000_GPIO_PORT_C | 9;
	gpio_map[DPAD_RIGHT]		= LF2000_GPIO_PORT_C | 10;
	gpio_map[BUTTON_ESC]		= LF2000_GPIO_PORT_C | 11;	/* schematic calls this HOME_BTN_L */
	gpio_map[RT_BATTPACK_DET_L]	= LF2000_GPIO_PORT_C | 12;
	gpio_map[DPAD_DOWN]		= LF2000_GPIO_PORT_C | 13;
